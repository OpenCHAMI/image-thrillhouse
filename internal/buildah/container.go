...
//
// The container name is generated by buildah (unique per invocation) —
// the image name from the config only shows up in the committed tags, not
// in the working container's name.
//
